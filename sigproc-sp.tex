...
\keywords{USB, Microkernel} % NOT required for Proceedings
...
Every time an object \emph{a}  tries to access another \emph{b}, it is checked if \emph{a} might access \emph{b} in the way \emph{a} is trying to.
